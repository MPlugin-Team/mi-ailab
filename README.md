...
> **Образовательный ML-фреймворк который масштабируется от ноутбука школьника до сервера с 8 GPU.**
...
Создано школьником из РФ. Если Mi-AiLab помог тебе разобраться в ML или
ускорил эксперимент — поставь ⭐ на GitHub. Это бесплатная, но самая ценная
обратная связь.

> "Школьная арифметика, потом Шекспир, потом свой ChatGPT — всё в одной программе.
